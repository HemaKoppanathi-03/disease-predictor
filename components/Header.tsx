        ...
        <div className="flex justify-between items-center py-3">
          ...
          <div className="hidden sm:flex items-center space-x-2">
            <div className="flex items-center space-x-1 bg-slate-100 p-1 rounded-lg">
             ...
             <button onClick={onLogout} className="px-3 py-2 text-sm font-semibold rounded-md transition-colors duration-200 text-red-600 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                Logout
            </button>
          </div>
        </div>
        <div className="sm:hidden flex items-center justify-between space-x-1 bg-slate-100 p-1 rounded-lg mb-2">
            <div className="flex items-center overflow-x-auto space-x-1">
             ...
             <button onClick={onLogout} className="ml-2 px-3 py-2 text-sm font-semibold rounded-md transition-colors duration-200 text-red-600 hover:bg-red-100 focus:outline-none">
                Logout
            </button>
        </div>
      </div>
